...
public class AppServer {
    ...
    public void start() throws IOException {
        ...
        server.createContext("/api/suggestions/graph", networkHandler);
        
        BenchmarkHandler benchmarkHandler = new BenchmarkHandler();
        server.createContext("/api/benchmark", benchmarkHandler);
        server.createContext("/api/suggestions/benchmark", benchmarkHandler);
